...
export function createOfficeWorld(host: HTMLElement, fail: () => void) {
 ...
 const positions=[[6,4.4,7.6],[3.2,3.15,1.2],[-.1,3.95,-3.4],[6,3.45,-5.7],[.15,3.9,-10.4],[5,3.25,-13.5]].map(v=>new T.Vector3(...v as [number,number,number]));
