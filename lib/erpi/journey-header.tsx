...
import {GOOGLE_APPOINTMENT_URL,SHOPIFY_STORE_URL} from './live-links';
const groups=[
 ...
 {name:'Faire appel à ERPI',intro:'Du premier échange à l’intervention.',links:[['Prendre rendez-vous',GOOGLE_APPOINTMENT_URL],['Un phénomène chez vous ?','/interventions'],['Signaler un phénomène','/signaler'],['Lieux & professionnels','/professionnels'],['Contacter l’équipe','/contact']]},
 ...
 {name:'Boutique & outils',intro:'S’équiper sur le terrain et organiser ses observations.',links:[['La boutique',SHOPIFY_STORE_URL],['Guide du matériel','/materiel'],['Applications ERPI','/applications']]}
];
